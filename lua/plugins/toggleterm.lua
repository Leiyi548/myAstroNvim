return {
  ...
  keys = {
    ...
    {"<C-4>","<cmd>ToggleTerm direction=tab<cr>",mode = {"n","x","i","t"},desc= "toggleterm in new tab"},
    {"<C-l>","<cmd>ToggleTerm direction=vertical size=40<cr>",mode = {"n","x","i","t"},desc= "toggleterm vertical split"},
    {"<C-3>","<cmd>ToggleTerm direction=float<cr>",mode = {"n","x","i","t"},desc= "toggleterm horizontal float"},
    -- stylua: ignore end
  },
}
