return {
  ...
  config = function(_, opts)
    ...
    vim.api.nvim_create_autocmd("User", {
      ...
      callback = function(args) vim.keymap.set("n", "`", files_set_cwd, { buffer = args.data.buf_id }) end,
    })
    ...
    vim.api.nvim_create_autocmd("User", {
      pattern = "MiniFilesBufferCreate",
      callback = function(args) vim.keymap.set("n", "gY", yank_relative_path, { buffer = args.data.buf_id }) end,
    })
